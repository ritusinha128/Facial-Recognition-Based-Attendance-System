...
app.config.update(
    ...
    MAIL_PORT = 465,
    MAIL_USE_SSL = True,
    MAIL_USERNAME = 'ritusinha128@gmail.com',
    MAIL_PASSWORD = 'ritu1999',
    MAIL_DEFAULT_SENDER = 'ritusinha128@gmail.com'
    )
mail = Mail(app)
...
# connection with mysql database using python package pymysql

conn = pymysql.connect(host="localhost",user="root",password="",db="login_info")
