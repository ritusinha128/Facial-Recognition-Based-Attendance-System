...
def function(xyz):
	...
	label_lines = [line.rstrip() for line in tf.io.gfile.GFile(APP_ROOT + "\\tensor\\tf_files\\retrained_labels.txt")]

	with tf.io.gfile.GFile(APP_ROOT + "\\tf_files\\retrained_graph.pb",'rb') as f:
